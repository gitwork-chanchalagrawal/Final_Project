    ...
    return (
        <>
            <div className="container">
                ...
                <p>
                    DoctorAppointment is a platform for booking medical consultations with specialist doctors in your city online. Patient can book an
                ...
                <p className="text-muted">Regards, from creators:
                    <ul>
                        <li>Chanchal Agrawal</li>
                        <li>Sharayu Dhavandkar</li>
                    </ul>
                </p>
            </div>
        </>
