        ...
        <>
            <div className="container">
                ...
                <ul style={{color : "blue"}}>
                    <li>
                        <h4>
                       <input value="doctorappointment87@gmail.com" disabled id='copytext1' style={{"border":"none", "width":"400px"}}></input> <a href='mailto:doctorappointment87@gmail.com'> <button style={{ "marginLeft": "0px", "borderRadius": "5px", "fontSize": "12px" }}>Send Email</button></a><p id='copy1'></p>                   
                        </h4>
                    </li>
                    <li>
                        <h4>
                        <input value="chanchalagrawal85@gmail.com" disabled id='copytext2' style={{"border":"none", "width":"400px"}}></input>  <button onClick={copyText2} style={{ "marginLeft": "0px", "borderRadius": "5px", "fontSize": "12px" }}>Copy</button><p id='copy2'></p>         
                        </h4>
                    </li>
                    <li>
                        <h4>
                        <input value="sharayudhavandkar@gmail.com" disabled id='copytext5' style={{"border":"none", "width":"400px"}}></input>  <button onClick={copyText5} style={{ "marginLeft": "0px", "borderRadius": "5px", "fontSize": "12px" }}>Copy</button><p id='copy5'></p>         
                        </h4>
                    </li>
                </ul>
                <p><h3>Call Us :</h3><input value="+911234567890" disabled id='copytext3' style={{"border":"none", "width":"400px"}}></input>  <button onClick={copyText3} style={{ "marginLeft": "0px", "borderRadius": "5px", "fontSize": "12px" }}>Copy</button> </p><p id='copy3'></p> 
                <p><input value="+911237474747" disabled id='copytext4' style={{"border":"none", "width":"400px"}}></input>  <button onClick={copyText4} style={{ "marginLeft": "0px", "borderRadius": "5px", "fontSize": "12px" }}>Copy</button> </p><p id='copy4'></p> 
